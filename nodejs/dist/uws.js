...
class Server extends EventEmitter {
    constructor(options, callback) {
        ...
        this.serverGroup = native.server.group.create();//Hub.createGroupServer();//new uws.Hub(nativeOptions, options.maxPayload === undefined ? 1048576 : options.maxPayload);
    ...
    broadcast(message, options) {
        this.serverGroup.broadcast(message, options && options.binary || false);
    }
